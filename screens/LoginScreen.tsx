  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-white p-6 md:p-12 font-mono">
      <div className="w-full max-w-[480px] flex flex-col gap-6">
        ...
        <form className="flex flex-col gap-5 mt-4" onSubmit={(e) => { e.preventDefault(); onLogin(); }}>
          ...
          <button className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary hover:bg-primary/90 text-white text-base font-bold leading-normal tracking-normal shadow-sm transition-all active:scale-[0.98] mt-2">
